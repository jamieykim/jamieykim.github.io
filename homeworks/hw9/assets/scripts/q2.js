...
document.getElementById("picture-1").onclick = function() {unhideLightbox1()};
...
document.getElementById("picture-2").onclick = function() {unhideLightbox2()};
...
document.getElementById("picture-3").onclick = function() {unhideLightbox3()};
