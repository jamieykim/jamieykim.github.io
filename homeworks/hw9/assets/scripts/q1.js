...
function setBackgroundColor(color) {
    ...
    let bg = document.getElementById("q1-container");
...
document.getElementById("q1-btn-red").onclick = function() {redButtonClicked()};
...
document.getElementById("q1-btn-yellow").onclick = function() {yellowButtonClicked()};
...
document.getElementById("q1-btn-green").onclick = function() {greenButtonClicked()};
...
document.getElementById("q1-btn-lightblue").onclick = function() {lightblueButtonClicked()};
...
document.getElementById("q1-btn-blue").onclick = function() {blueButtonClicked()};